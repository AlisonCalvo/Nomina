...
('Gestion de Reportes', NULL, NULL, NULL, 34, 'Gestion de Reportes'),
(NULL, 'Reportes', 'description', '/reportes', 35, 'Reportes');
...
(true, 70, 1, null), -- Gestion de reportes
...
(false, 70, 2, null), -- Gestion de reportes
