...
('Cuenta Cobro', NULL, NULL, NULL, 15, 'CuentaCobro'),
...
('Tipo Documento', NULL, NULL, NULL, 21, 'TipoDocumento'),
...
('Tipo Contrato', NULL, NULL, NULL, 24, 'TipoContrato'),
...
('Periodicidad Pago', NULL, NULL, NULL, 27, 'PeriodicidadPago'),
