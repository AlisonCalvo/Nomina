/**
 * @fileoverview Componente de eliminación para la entidad Informe
 */
...
/**
 * Componente para la eliminación de registros de Informe
 */
@Component({
  selector: 'app-eliminar-informe',
  templateUrl: './eliminar-informe.component.html',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  styleUrls: ['./eliminar-informe.component.css']
})
export class EliminarInformeComponent implements OnInit {
  /** Lista de registros de Informe */
  ...
  private initializeFields() {
    this.informeService.findAll().subscribe(
      data => {
        // @ts-ignore
        this.informes = data.map(item => Object.assign(new InformeComponent(), item));
      },
      error => {
